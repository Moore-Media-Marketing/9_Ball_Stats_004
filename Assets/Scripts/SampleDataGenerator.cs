...
public class SampleDataGenerator:MonoBehaviour
	...
	private Team GenerateTeam()
		...
		// Use DatabaseManager to get the highest team ID and add 1 to avoid ID conflicts
		int teamId = DatabaseManager.Instance.GetAllTeams().Max(t => t.id) + 1;
	...
	// Add any extra utility functions here if needed
