...
public class TeamPanel:MonoBehaviour
	...
	public void DisplayTeamInfo(Team team)
		...
		// Subscribe to the team list change event
		currentTeam.OnTeamListChanged += OnTeamListChanged;
		...
		// Access the Players property instead of 'players'
	...
	// Method to handle team list changes
	private void OnTeamListChanged()
		{
		// Update the UI or perform any necessary actions when the team list changes
		Debug.Log("Team list changed! Updating UI...");
		DisplayTeamInfo(currentTeam); // Re-display team info
		}
	...
	// Unsubscribe from the event when the panel is disabled
